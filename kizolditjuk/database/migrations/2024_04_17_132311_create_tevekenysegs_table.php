...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Tevekenyseg::create(['tevekenyseg_nev' => 'ültettem virágot', 'pontszam' => 20]);
        ...
        Tevekenyseg::create(['tevekenyseg_nev' => 'tartós csomagolású terméket vásároltam pl üvegbe vettem a tejet, nem használtam', 'pontszam' => 70]);
        Tevekenyseg::create(['tevekenyseg_nev' => 'környezetbarát csomagolású terméket vásároltam', 'pontszam' => 30]);
        Tevekenyseg::create(['tevekenyseg_nev' => 'kevesebb húst etten a héten', 'pontszam' => 50]);
        ...
        Tevekenyseg::create(['tevekenyseg_nev' => 'kevesebb ruhát/terméket vásároltam a héten, hogy fenntarthatóbb legyen a környezt', 'pontszam' => 70]);
